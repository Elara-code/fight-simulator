...
// Icons are decorative by default — hide from assistive tech so the button's
// aria-label / visible text owns the accessible name. Callers can still pass
// aria-hidden={false} + role="img" + aria-label to make an icon meaningful.
...
export const Plus = (p: P) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" {...base} {...p}>
